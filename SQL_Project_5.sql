...
-- Recreate tables as per provided dataset
...
-- 1. Trigger: Update customer balance on invoice INSERT
...
-- 2. Procedure: Add a new customer
...
-- 4. Trigger: Update customer balance on invoice DELETE
...
-- 5. Function: Get count of invoices for a given customer
CREATE OR REPLACE FUNCTION get_invoice_count(p_cust_num IN NUMBER)
RETURN NUMBER
IS
  v_count NUMBER;
BEGIN
...
-- Test Examples (to be run interactively in SQL*Plus or Oracle SQL Developer)
